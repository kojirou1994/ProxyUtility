...
public enum ClashProxy: Codable, Equatable {
    ...
    public var type: ProxyType {
        switch self {
        case .shadowsocks(_): return .ss
        case .socks5(_): return .socks5
        case .http(_): return .http
        case .vmess(_): return .vmess
        case .snell(_): return .snell
        case .trojan(_): return .trojan
        }
    }
}
